...
export type Message = {
    msg: 'Account already exists' | 'Bad parameter' | 'Not found' | 'Internal server error' | 'No token, authorization denied' | 'Token is not valid' | 'Invalid Credentials';
};
...
export type GetUsersByIdentifierError = GetUsersByIdentifierErrors[keyof GetUsersByIdentifierErrors];
...
export type GetUsersByIdentifierResponse = GetUsersByIdentifierResponses[keyof GetUsersByIdentifierResponses];
